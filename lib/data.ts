...
export const resume: {
  ...
  notable: {
    ...
    description:
      'Presented "The long and winding road: CSR to static export to SSG" to a global audience, detailing Peloton\u2019s multi-year migration strategy, performance gains, and architectural decisions.',
